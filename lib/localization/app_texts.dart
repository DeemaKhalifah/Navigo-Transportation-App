...
class AppTexts {
  ...
  static const Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      'noActiveTripsNow': 'No active trips are available right now.',
      'couldNotGeocodeRoute': 'Could not geocode route points',
      'couldNotLoadRoute': 'Could not load route polyline',
      'enableLocationServices': 'Please enable location services',
      'locationPermissionDenied': 'Location permission denied',
      'enableLocationPermissionSettings':
      ...
      'loadingAreaName': 'Loading area name...',
      'locationTimedOutRetry':
          'Location is taking too long. Please try again.',
      'requestTimedOutRetry':
          'The request is taking too long. Please try again.',
      'trustedOperationFailed':
          'The secure operation failed. Please try again.',
      'failedToLoadSchedules': 'Failed to load schedules',
      'tripEndedSuccessfully': 'Trip ended successfully',
      'failedToEndTrip': 'Failed to end trip. Please try again.',
      'close': 'Close',
      ...
      'noTripsForFilters': 'No trips match the selected filters',
      ...
      'minute': 'Minute',
      'setTime': 'Set time',
      'enterValidTime': 'Enter an hour from 1-12 and minutes from 00-59',
      ...
      'departureMustBeFuture': 'Departure date and time must be in the future',
      'savedTrips': 'Saved',
      'tripsLabel': 'trips',
    ...
    'ar': {
      ...
      'noActiveTripsNow': 'لا توجد رحلات نشطة متاحة الآن.',
      'couldNotGeocodeRoute': 'تعذر تحديد نقاط المسار على الخريطة',
      'couldNotLoadRoute': 'تعذر تحميل مسار الرحلة على الخريطة',
      'enableLocationServices': 'يرجى تفعيل خدمات الموقع',
      'locationPermissionDenied': 'تم رفض إذن الموقع',
      'enableLocationPermissionSettings': 'فعّل إذن الموقع من الإعدادات',
      'failedToLoadRoutes': 'فشل تحميل المسارات',
      'errorGettingLocation': 'حدث خطأ أثناء تحديد الموقع',
      'loadingAreaName': 'جارٍ تحميل اسم المنطقة...',
      'locationTimedOutRetry':
          'استغرق تحديد الموقع وقتاً طويلاً. يرجى المحاولة مرة أخرى.',
      'requestTimedOutRetry':
          'استغرق الطلب وقتاً طويلاً. يرجى المحاولة مرة أخرى.',
      'trustedOperationFailed':
          'فشلت العملية الآمنة. يرجى المحاولة مرة أخرى.',
      'failedToLoadSchedules': 'فشل تحميل الجداول',
      'tripEndedSuccessfully': 'تم إنهاء الرحلة بنجاح',
      'failedToEndTrip': 'فشل إنهاء الرحلة. يرجى المحاولة مرة أخرى.',
      'close': 'إغلاق',
      ...
      'noTripsForFilters': 'لا توجد رحلات تطابق عوامل التصفية المحددة',
      ...
      'minute': 'الدقيقة',
      'setTime': 'تعيين الوقت',
      'enterValidTime': 'أدخل ساعة من 1 إلى 12 ودقائق من 00 إلى 59',
      ...
      'departureMustBeFuture': 'يجب أن يكون تاريخ ووقت المغادرة في المستقبل',
      'savedTrips': 'تم حفظ',
      'tripsLabel': 'رحلات',
